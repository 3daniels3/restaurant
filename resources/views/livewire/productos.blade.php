                        ...
                        <tr class="hover">
                            ...
                            <td>
                                <div class="flex justify-center items-center space-x-2">
                                    ...
                                    <button class="btn btn-error" wire:click="select_index({{$item->id}})">Eliminar</button>   
                                </div>
                            </td>
                        </tr>
                    @endforeach
        ...
        <x-slot name="content">
            <div class="flex flex-col space-y-4">
                ...
                <div>
                    ...
                    <x-input id="precio" type="number" step="0.01" class="w-full" wire:model.defer="precio" required autocomplete="precio" />
  
                 <div>
                    <x-label for="descripcion" value="Descripcion" />
                    <x-input id="descripcion" type="text" class="w-full" wire:model.defer="descripcion" required autofocus autocomplete="descripcion" />
                  </div>
